angular.module('7MinWorkout')
  .controller('WorkoutController', ['$scope', '$interval', '$location', 'workoutHistoryTracker', 'appEvents', WorkoutController])

function WorkoutController ($scope, $interval, $location, workoutHistoryTracker, appEvents) {
